...
class TrainingController extends Controller
{
    ...
    public function store(CreateTrainingRequest $request): JsonResponse
    {
        ...
        try {
            ...
            if (data_get($request, 'banner_upload')) {
                $training->addMediaFromRequest('banner_upload')->toMediaCollection(Training::BANNER_MEDIA_COLLECTION);
            }
    ...
    {
        return $this->respondSuccess(
            TrainingResource::make($training->loadMissing('logo', 'banner', 'lecturerAvatar'))
        );
    }
